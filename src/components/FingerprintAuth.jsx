...
const FingerprintAuth = () => {
  ...
  const handleScan = async () => {
    try {
      ...
      // MOSIP API endpoint
      const response = await fetch('https://traisapi.onrender.com/', {
        method: 'GET',
        headers: {
      ...
      if (response.ok) {
        ...
        const mockUserDetails = {
            "token": "string",
            "farming_type": 0,
            "last_season_status": true,
            "last_season_crop": "string",
            "yield_status": 0,
            "last_season_feltilizer_type": "string",
            "last_season_feltilizer_size": 0,
            "crop_type": "string",
            "seeds": 0,
            "fertilizer": 0,
            "land_size": 0,
            "land_use": 0,
            "current_year_land_use": 0,
            "machinery_type": 0,
            "labour": 0,
            "lat": "string",
            "long": "string"
      ...
      <div className="m-10">
        ...
        <div className="mb-3">
          <TETabs>
            ...
            >
              ID Input Authentication
            </TETabsItem>
          </TETabs>

          <TETabsContent className='mt-6'>
            <TETabsPane show={basicActive === "tab1"}>
            <p className=" text-gray-700">Prompt the Farmer to Scan Fingerprint</p>
            <div onClick={handleScan} className="text-blue-500 text-6xl mb-4 relative flex flex-col items-center justify-center p-6 bg-white  rounded-lg cursor-pointer transition-transform transform hover:scale-105">
            ...
            <TETabsPane show={basicActive === "tab2"}>
              <div className='flex flex-col gap-6 items-center justify-center'>
                <p className=" text-gray-700">Enter Farmers ID Number</p>   
                <TEInput
                  type="text"
                  id="Input1"
                  label="Farmer ID"
